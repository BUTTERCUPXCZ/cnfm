...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(0.02, 'Distance out of bounds (BMH Makaha)')
    .max(31.542, 'Distance cannot exceed BU Hawaii'),
...
const Segment5SeaUS: React.FC<Segment5SeaUSProps> = ({
