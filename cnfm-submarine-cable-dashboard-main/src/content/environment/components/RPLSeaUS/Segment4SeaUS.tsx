...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .max(6626.105, 'Distance cannot exceed BU2'),
  cutType: Yup.string().required('Cut type selection is required')
});

const Segment4SeaUS: React.FC<Segment4SeaUSProps> = ({
