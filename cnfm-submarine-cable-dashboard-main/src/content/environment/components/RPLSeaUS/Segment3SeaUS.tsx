...
const Segment3SeaUS: React.FC<Segment3SeaUSProps> = ({
  ...
  const fetchCableData = async () => {
    try {
      ...
      const response = await fetch(`${apiBaseUrl}${port}/sea-us-rpl-s3`, {
