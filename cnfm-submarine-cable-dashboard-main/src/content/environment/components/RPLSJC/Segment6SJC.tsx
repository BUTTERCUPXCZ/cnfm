...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(6.51, 'Distance out of bounds (Telisai BMH, Brunei)')
    .max(595.489, 'Distance cannot exceed Telisai BU (BU3)'),
  cutType: Yup.string().required('Cut type selection is required')
});

const Segment6SJC: React.FC<Segment6SJCProps> = ({
