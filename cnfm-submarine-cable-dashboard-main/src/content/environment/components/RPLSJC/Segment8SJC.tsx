...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(0.129, 'Distance out of bounds (BMH: Nasugbu, Philippines)')
    .max(441.517, 'Distance cannot exceed Nasugbu BU (BU4)'),
  cutType: Yup.string().required('Cut type selection is required')
});

const Segment8SJC: React.FC<Segment8SJCProps> = ({
