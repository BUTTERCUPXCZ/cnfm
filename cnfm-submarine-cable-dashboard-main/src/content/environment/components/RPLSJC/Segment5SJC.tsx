...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(0, 'Distance out of bounds: Songkhla BU (BU2)')
    .max(533.385, 'Distance cannot exceed Telisai BU (BU3)'),
...
const Segment5SJC: React.FC<Segment5SJCProps> = ({
