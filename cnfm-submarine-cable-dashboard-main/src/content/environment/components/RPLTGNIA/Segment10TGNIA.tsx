...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(0, 'Distance out of bounds (BMH Ballesteros)')
    .max(29.983, 'Distance cannot exceed BU4'),
  cutType: Yup.string().required('Cut type selection is required')
});

const Segment10TGNIA: React.FC<Segment10TGNIAProps> = ({
