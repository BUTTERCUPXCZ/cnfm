...
const validationSchema = Yup.object({
  kmValue: Yup.number()
    ...
    .min(0, 'Distance out of bounds (BU3A)')
    .max(502.392, 'Distance cannot exceed BU4'),
  cutType: Yup.string().required('Cut type selection is required')
});

const Segment4TGNIA: React.FC<Segment4TGNIAProps> = ({
